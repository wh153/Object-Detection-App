...
var timingPrediction;
var speedLabel = document.querySelector("#speed-pred-label");
...
class App extends React.Component {
  ...
  renderPredictions = predictions => {
    if(!timingPrediction) {
      timingPrediction = new Date();
    } else {
      let diff = new Date() - timingPrediction;
      speedLabel.innerHTML = `${diff} ms`;
      timingPrediction = new Date();
    }
...
ReactDOM.render(<App />, rootElement);// JavaScript File
